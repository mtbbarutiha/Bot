...
export const PET_BREEDS_SEED: Array<{
  ...
  { speciesCode: 'other', nameFa: 'ایگوآنا', nameEn: 'Iguana', sortOrder: 2 },
  { speciesCode: 'other', nameFa: 'جوجه تیغی', nameEn: 'Hedgehog', sortOrder: 3 },
  { speciesCode: 'other', nameFa: 'فرت', nameEn: 'Ferret', sortOrder: 4 },
  { speciesCode: 'other', nameFa: 'خوکچه هندی', nameEn: 'Guinea Pig', sortOrder: 5 },
  { speciesCode: 'other', nameFa: 'چینچیلا', nameEn: 'Chinchilla', sortOrder: 6 },
  { speciesCode: 'other', nameFa: 'ماهی زینتی', nameEn: 'Ornamental Fish', sortOrder: 7 },
